function WhatWeDo() {
  return (
    <div className="relative py-0   grid gap-2  grid-rows-2  h-screen z-40">
      <div className="p-8 rounded-lg mb-10 mt-6  mx-4 sm:mx-8 md:mx-16 lg:ml-24 xl:ml-32">
        <h3 className="text-[48px] w-[800px]  font-[700]">What we do</h3>
        <p className="text-[18px] w-[800px] font-[400] leading-[27px]">
          ...
          services, full product custom software development or help to scale
          your company.
        </p>
      </div>
      <div className=" mb-10  drop-shadow-2xl   mx-4 sm:mx-8 md:mx-16 lg:ml-24 xl:ml-32 flex flex-wrap justify-center space-x-6 h-[690px] w-[1200px] ">
        <div className=" rounded-lg h-[303px] w-[383px] p-10   bg-purple-100 ">
          <svg
          ...
          >
            <path
              ...
              stroke="#0FA4EA"
              stroke-width="3.44505"
              stroke-miterlimit="10"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
          </svg>
          <h1 className="font-[600] text-[26px] py-2 ">Product Scope</h1>
          <p className=" leading-[25px] font-[400] text-[16px]">
        ...
        <div className=" rounded-lg h-[303px] w-[383px] p-10 bg-purple-100 ">
          ...
          >
            <path
              ...
              stroke="#E7107E"
              stroke-width="3.25832"
              stroke-miterlimit="10"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
          </svg>{" "}
          <h1 className="font-[600] text-[26px] py-2 ">UX/UI</h1>
          <p className=" leading-[25px] font-[400] text-[16px]">
            Design an engaging product that is easy-to-use, attractive and
            functional
          </p>
        </div>
        <div className=" rounded-lg h-[303px] w-[383px] p-10 bg-purple-100 ">
