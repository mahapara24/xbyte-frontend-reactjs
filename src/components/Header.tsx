...
const Header = () => {
  return (
    <div className="fixed grid grid-cols-3 bg-black/80 top-0 w-full text-white items-center p-5 z-50">
      <div className="ml-2 p-0 text-[20px] sm:text-[30px] font-bold">
        <a href="#">
          <span className="text-purple-800">x</span>Bytes.io
        </a>
      </div>
      <div className="hidden md:flex justify-center space-x-4 text-[18px] py-2.5 font-normal">
        <ul className="flex space-x-4">
          <li className="hover:text-purple-800 cursor-pointer">Work</li>
          <li className="relative">
            <button className="hover:text-purple-800 cursor-pointer">
